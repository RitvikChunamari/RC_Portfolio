            ...
            <div >
                <nav>
                    ...
                    <div className="links-container">
                        <Link to="/"><a className='fancy'>Home</a>
                        </Link>
                        <Link to="/"><a className='fancy' >Resume</a></Link>
                        <Link to="/About"><a className='fancy'>About</a></Link>
                        <Link to="/Work"><a className='fancy'>Work</a></Link>
                        <Link to="/Contact"> <a className='fancy'>Contact</a></Link>
